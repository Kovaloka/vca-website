...
function SideNav() {
  ...
  return (
    <>
      {/* Mobile — top bar */}
      <div
        className="md:hidden fixed top-0 inset-x-0 z-[100]"
        style={{
          transform: `translateY(${visible && !hidden ? '0px' : '-100%'})`,
          transition: 'transform 0.5s ease-in-out'
        }}
      >
        <div className="bg-black/70 backdrop-blur-md border-b border-gray-800 px-6 py-2 flex items-center justify-between">
